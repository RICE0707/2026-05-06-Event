...
execute as @s[tag=!spawning] at @s run summon armor_stand 146 -24 67 {Silent:1b,Invisible:1b,Invulnerable:1b,Small:1b,PersistenceRequired:1b,Motion:[-0.85,0.25,-0.40],Tags:["spawning_armor_stand"]}
...
##NEEDS TO UPDATE THE HATS OF PLAYER HERE!
